...
import { TemplateUno } from '../components/template-uno/template-uno';
import { TemplateDos } from '../components/template-dos/template-dos';
import { TemplateTres } from '../components/template-tres/template-tres';
import { FloatingWidgetComponent } from '../components/floating-widget/floating-widget';
...
export class LandingPageComponent implements OnInit {
  ...
  async ngOnInit() {
    ...
    const success = await this.configService.loadConfig(slugValue);
